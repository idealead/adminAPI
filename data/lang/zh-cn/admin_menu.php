...
return array (
  ...
  'API_TEST_INDEX' => 'api测试',
  'AUDIT_AUDITLABEL_INDEX' => '待审核标签内容',
  'AUDIT_AUDITTEMPLATE_DETAILS' => '详细信息显示',
  'AUDIT_AUDITTEMPLATE_INDEX' => '待审核模板内容',
  'AUDIT_FAILURETEMPLATE_INDEX' => '审核失败内容',
  'CONFIGURATION_CONFIGURATION_INDEX' => '常量修改',
  'CONFIGURATION_CUTOUT_INDEX' => '抠图统计',
  'COPYWRITING_COPYWRITING_DEFAULT' => '文案管理',
  'EXAMINE_INDEX_DEFAULT' => '审核管理',
  'FEEDBACK_FEEDBACK_INDEX' => '用户反馈',
  'INFORMATION_INDEX_DEFAULT' => '数据统计',
  ...
  'STATISTICAL_AUDITSTATISTICAL_INDEX' => '审核模板人员统计',
  'STATISTICAL_CUTOUT_INDEX' => '抠图统计',
  'STATISTICAL_DEPARTMENTSTATISTICAL_DEFAULT' => '统计',
  'STATISTICAL_DEPARTMENTSTATISTICAL_INDEX' => '各部门消费统计',
  'STATISTICAL_DRAWSTATISTICAL_INDEX' => '绘制模板人员统计',
  'STATISTICAL_ORDER_INDEX' => '订单统计',
  'STATISTICAL_STATISTICAL_INDEX' => '员工信息统计',
  'SUBSTANCE_DIMENSION_INDEX' => '维度管理',
  'SUBSTANCE_INDEX_DEFAULT' => '内容管理',
  'SUBSTANCE_LABEL_CLASSIFY' => '标签分类管理',
  'SUBSTANCE_LABEL_DEFALUT' => '标签管理',
  'SUBSTANCE_LABEL_INDEX' => '标签列表',
  'SUBSTANCE_MATERIAL_INDEX' => '素材管理',
  'SUBSTANCE_TEMPLATE_CLASSIFY' => '模板分类管理',
  'SUBSTANCE_TEMPLATE_DEFALUT' => '模版管理',
  'SUBSTANCE_TEMPLATE_INDEX' => '模板列表',
  'TASK_TASKCATEGORY_INDEX' => '任务发布',
  'TASK_TASKDRAW_INDEX' => '绘制模板任务管理',
  'TASK_TASKLABEL_INDEX' => '标签审核任务管理',
  'TASK_TASKTEMPLATE_DEFAULT' => '任务管理',
  'TASK_TASKTEMPLATE_INDEX' => '模板审核任务管理',
  'TASK_TASKTEST_INDEX' => '测试',
  'USER_ADMINASSET_DELETE' => '删除文件',
  'USER_ADMINASSET_INDEX' => '资源管理',
  'USER_ADMININDEX_BAN' => '本站用户拉黑',
  'USER_ADMININDEX_CANCELBAN' => '本站用户启用',
  'USER_ADMININDEX_DEFAULT' => '成员管理',
  ...
  'WEBSITE_ARTICLE_INDEX' => '文章管理',
  'WEBSITE_BANNER_INDEX' => '轮播管理',
  'WEBSITE_CONTACT_INDEX' => '联系我们',
  'WEBSITE_HR_INDEX' => '招聘管理',
  'WEBSITE_INDEX_DEFAULT' => '网站管理',
  'WEBSITE_NAV_INDEX' => '菜单管理',
  'WORD_WORD_INDEX' => '模板列表',
);